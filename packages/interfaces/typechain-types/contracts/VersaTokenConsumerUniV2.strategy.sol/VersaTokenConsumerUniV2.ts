...
export interface VersaTokenConsumerUniV2Interface extends utils.Interface {
  functions: {
...
export interface VersaTokenConsumerUniV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VersaTokenConsumerUniV2Interface;

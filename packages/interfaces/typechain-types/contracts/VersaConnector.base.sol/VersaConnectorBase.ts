...
export interface VersaConnectorBaseInterface extends utils.Interface {
  functions: {
...
export interface VersaConnectorBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VersaConnectorBaseInterface;

...
export interface VersaConnectorNonEthInterface extends utils.Interface {
  functions: {
...
export interface VersaConnectorNonEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VersaConnectorNonEthInterface;

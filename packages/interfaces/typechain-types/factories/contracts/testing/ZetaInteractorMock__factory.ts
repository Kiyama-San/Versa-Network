...
import type {
  VersaInteractorMock,
  VersaInteractorMockInterface,
} from "../../../contracts/testing/VersaInteractorMock";
...
type VersaInteractorMockConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: VersaInteractorMockConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class VersaInteractorMock__factory extends ContractFactory {
  constructor(...args: VersaInteractorMockConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    VersaConnectorAddress: string,
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<VersaInteractorMock> {
    return super.deploy(
      VersaConnectorAddress,
      overrides || {}
    ) as Promise<VersaInteractorMock>;
  }
  override getDeployTransaction(
    VersaConnectorAddress: string,
    overrides?: Overrides & { from?: string | Promise<string> }
  ): TransactionRequest {
    return super.getDeployTransaction(VersaConnectorAddress, overrides || {});
  }
  override attach(address: string): VersaInteractorMock {
    return super.attach(address) as VersaInteractorMock;
  }
  override connect(signer: Signer): VersaInteractorMock__factory {
    return super.connect(signer) as VersaInteractorMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VersaInteractorMockInterface {
    return new utils.Interface(_abi) as VersaInteractorMockInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VersaInteractorMock {
    return new Contract(address, _abi, signerOrProvider) as VersaInteractorMock;
  }
}

...
import type {
  VersaReceiverMock,
  VersaReceiverMockInterface,
} from "../../../contracts/testing/VersaReceiverMock";
...
type VersaReceiverMockConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: VersaReceiverMockConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class VersaReceiverMock__factory extends ContractFactory {
  constructor(...args: VersaReceiverMockConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<VersaReceiverMock> {
    return super.deploy(overrides || {}) as Promise<VersaReceiverMock>;
  }
  ...
  override attach(address: string): VersaReceiverMock {
    return super.attach(address) as VersaReceiverMock;
  }
  override connect(signer: Signer): VersaReceiverMock__factory {
    return super.connect(signer) as VersaReceiverMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VersaReceiverMockInterface {
    return new utils.Interface(_abi) as VersaReceiverMockInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VersaReceiverMock {
    return new Contract(address, _abi, signerOrProvider) as VersaReceiverMock;
  }
}
